        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-12">
            <div className="single-dd">
              ...
              <p>
                Lorem Ipsum is simply text of the Lorem Ipsum is simply my text
                of ply text of the Ipsum is simply text of thetypesetting Ipsum
                is simply text of the stry simply <br />
                dummy text of the printing and typesetting industry. Lorem Ipsum
                is simply text of the Lorem Ipsum is simply my text of{' '}
              </p>
            </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="single-dd">
              ...
              <p>
                Ipsum is simply text of the Lorem Ipsum is simply my text of ply
                text
              </p>

              <p>
                Lorem Ipsum is simply text of the Lorem Ipsum is simply my text
                of ply text of the Ipsum f the Lorem Ipsum is simply my text of
                ply text{' '}
              </p>
            </div>
          </div>
